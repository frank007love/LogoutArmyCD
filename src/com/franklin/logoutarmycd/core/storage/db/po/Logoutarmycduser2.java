...
/** 
 *        @hibernate.class
 *         table="logoutarmycduser_2"
 *     
*/
public class Logoutarmycduser2 implements IPoLogoutArmyCDUser,Serializable {
    ...
    /** full constructor */
    public Logoutarmycduser2(String fbuserid, Date joindate, String periodyear, String periodmonth, String perioddate, Integer reducedays, Integer otherreducedays) {
    ...
    /** default constructor */
    public Logoutarmycduser2() {
    }

    /** minimal constructor */
    public Logoutarmycduser2(String fbuserid) {
        this.fbuserid = fbuserid;
    }
