...
/** 
 *        @hibernate.class
 *         table="logoutarmycduser_0"
 *     
*/
public class Logoutarmycduser0 implements IPoLogoutArmyCDUser,Serializable {
    ...
    /** full constructor */
    public Logoutarmycduser0(String fbuserid, Date joindate, String periodyear, String periodmonth, String perioddate, Integer reducedays, Integer otherreducedays) {
    ...
    /** default constructor */
    public Logoutarmycduser0() {
    }

    /** minimal constructor */
    public Logoutarmycduser0(String fbuserid) {
        this.fbuserid = fbuserid;
    }
