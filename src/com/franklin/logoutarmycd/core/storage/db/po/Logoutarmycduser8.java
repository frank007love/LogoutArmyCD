...
/** 
 *        @hibernate.class
 *         table="logoutarmycduser_8"
 *     
*/
public class Logoutarmycduser8 implements IPoLogoutArmyCDUser,Serializable {
    ...
    /** full constructor */
    public Logoutarmycduser8(String fbuserid, Date joindate, String periodyear, String periodmonth, String perioddate, Integer reducedays, Integer otherreducedays) {
    ...
    /** default constructor */
    public Logoutarmycduser8() {
    }

    /** minimal constructor */
    public Logoutarmycduser8(String fbuserid) {
        this.fbuserid = fbuserid;
    }
