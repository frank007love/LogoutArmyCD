...
/** 
 *        @hibernate.class
 *         table="logoutarmycduser_1"
 *     
*/
public class Logoutarmycduser1 implements IPoLogoutArmyCDUser,Serializable {
    ...
    /** full constructor */
    public Logoutarmycduser1(String fbuserid, Date joindate, String periodyear, String periodmonth, String perioddate, Integer reducedays, Integer otherreducedays) {
    ...
    /** default constructor */
    public Logoutarmycduser1() {
    }

    /** minimal constructor */
    public Logoutarmycduser1(String fbuserid) {
        this.fbuserid = fbuserid;
    }
