...
/** 
 *        @hibernate.class
 *         table="logoutarmycduser_3"
 *     
*/
public class Logoutarmycduser3 implements IPoLogoutArmyCDUser,Serializable {
    ...
    /** full constructor */
    public Logoutarmycduser3(String fbuserid, Date joindate, String periodyear, String periodmonth, String perioddate, Integer reducedays, Integer otherreducedays) {
    ...
    /** default constructor */
    public Logoutarmycduser3() {
    }

    /** minimal constructor */
    public Logoutarmycduser3(String fbuserid) {
        this.fbuserid = fbuserid;
    }
