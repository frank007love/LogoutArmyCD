...
/** 
 *        @hibernate.class
 *         table="logoutarmycduser_7"
 *     
*/
public class Logoutarmycduser7 implements IPoLogoutArmyCDUser,Serializable {
    ...
    /** full constructor */
    public Logoutarmycduser7(String fbuserid, Date joindate, String periodyear, String periodmonth, String perioddate, Integer reducedays, Integer otherreducedays) {
    ...
    /** default constructor */
    public Logoutarmycduser7() {
    }

    /** minimal constructor */
    public Logoutarmycduser7(String fbuserid) {
        this.fbuserid = fbuserid;
    }
