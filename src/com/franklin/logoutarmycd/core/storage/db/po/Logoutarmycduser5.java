...
/** 
 *        @hibernate.class
 *         table="logoutarmycduser_5"
 *     
*/
public class Logoutarmycduser5 implements IPoLogoutArmyCDUser,Serializable {
    ...
    /** full constructor */
    public Logoutarmycduser5(String fbuserid, Date joindate, String periodyear, String periodmonth, String perioddate, Integer reducedays, Integer otherreducedays) {
    ...
    /** default constructor */
    public Logoutarmycduser5() {
    }

    /** minimal constructor */
    public Logoutarmycduser5(String fbuserid) {
        this.fbuserid = fbuserid;
    }
