...
/** 
 *        @hibernate.class
 *         table="logoutarmycduser_4"
 *     
*/
public class Logoutarmycduser4 implements IPoLogoutArmyCDUser,Serializable {
    ...
    /** full constructor */
    public Logoutarmycduser4(String fbuserid, Date joindate, String periodyear, String periodmonth, String perioddate, Integer reducedays, Integer otherreducedays) {
    ...
    /** default constructor */
    public Logoutarmycduser4() {
    }

    /** minimal constructor */
    public Logoutarmycduser4(String fbuserid) {
        this.fbuserid = fbuserid;
    }
