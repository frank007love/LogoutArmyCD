...
/** 
 *        @hibernate.class
 *         table="logoutarmycduser_6"
 *     
*/
public class Logoutarmycduser6 implements IPoLogoutArmyCDUser,Serializable {
    ...
    /** full constructor */
    public Logoutarmycduser6(String fbuserid, Date joindate, String periodyear, String periodmonth, String perioddate, Integer reducedays, Integer otherreducedays) {
    ...
    /** default constructor */
    public Logoutarmycduser6() {
    }

    /** minimal constructor */
    public Logoutarmycduser6(String fbuserid) {
        this.fbuserid = fbuserid;
    }
